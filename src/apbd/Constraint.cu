...
ConstraintGround::ConstraintGround(BodyRigidReference body, Contact c,
                                   Collision *collision)
    : lambda(Vector3f::Zero()),
      nw(c.nw),
      d(Vector3f::Zero()),
      body(body),
      xl(c.x1),
      xw(c.x2),
      contactFrame(Matrix3f::Zero()),
      w1(Vector3f::Zero()),
      raXnI1(Matrix3f::Zero()),
      delLinVel1(Matrix3f::Zero()),
      angDelta1(Matrix3f::Zero()),
      collision(collision) {}
...
ConstraintRigid::ConstraintRigid(BodyRigidReference body1,
    ...
    : lambda(Vector3f::Zero()),
      ...
      angDelta1(Matrix3f::Zero()),
      w2(Vector3f::Zero()),
      raXnI2(Matrix3f::Zero()),
      delLinVel2(Matrix3f::Zero()),
      angDelta2(Matrix3f::Zero()),
      collision(collision) {}
